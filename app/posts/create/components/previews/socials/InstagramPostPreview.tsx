        ...
        <div className="flex flex-col gap-2 bg-white p-5 rounded-md min-w-[300px]">
            ...
            <div className="flex justify-between">
                <div className="flex justify-center items-center gap-1">
                    <div className="flex gap-2 justify-center items-center">
                        {values.instagram[0]?.profilePicture ? (
                            <Image
                                src={values.instagram[0].profilePicture}
                                height={40}
                                width={40}
                                alt="Profile image"
                        ...
                        <p className="font-bold text-sm cursor-pointer">
                            {values.instagram[0]?.name || "Select an account"}
                        </p>
                    </div>
            ...
            <div className="flex h-12 gap-2 ">
                <p className="text-sm font-bold line-clamp-2 text-ellipsis">
                    <span className="mr-1">{values.instagram[0]?.name || "Select an account"}</span>
